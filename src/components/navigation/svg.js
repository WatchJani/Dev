export const SVG_Data = [
    {
        name: "Home",
        svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
            <g>
    ...
    {
        name: "About",
        svg: <svg viewBox="0 0 235 234" height="24" width="24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
            <g fill="none">
